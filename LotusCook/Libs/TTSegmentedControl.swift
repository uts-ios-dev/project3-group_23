...
open class TTSegmentedControl: UIView {
    ...
    @IBInspectable open var cornersRadius: CGFloat = -1 // for rounded corner radius use negative value, 0 to disable
    ...
    open override func layoutSubviews() {
        ...
        containerView.layer.cornerRadius = cornersRadius < 0 ? 0.5 * containerView.frame.size.height : cornersRadius
...
extension TTSegmentedControl {
    ...
    fileprivate func updateSelectedViewFrame() {
        ...
        thumbView.layer.cornerRadius = cornersRadius < 0 ? 0.5 * thumbView.frame.size.height : cornersRadius
